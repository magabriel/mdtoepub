...
1. **Sustitucion simple** — cada letra se reemplaza por otro signo
2. **Transposicion** — las letras se reordenan segun una clave
3. **Cifrado polialfabetico** — uso de multiples alfabetos de sustitucion
4. **Esteganografia** — ocultacion del mensaje en apariencia inocua

## Tecnicas de datacion por carbono-14

El laboratorio de la Universidad de Coimbra sometio los pergaminos a datacion por <sup>14</sup>C, arrojando una horquilla temporal de 1470–1520 d. C. con un margen de error del 95 %. La cifra coincidia con el reinado de D. Manuel I (r. 1495–1521), periodo de esplendor cultural conocido como *Manuelino*.

La formula de calibracion empleada fue:

> t = -8033 &middot; ln(F<sub>m</sub>)

donde F<sub>m</sub> representa la fraccion de <sup>14</sup>C medida respecto al estandar moderno.

## Cronologia de los hechos

| Ano | Acontecimiento | Lugar |
|-----|----------------|-------|
| 1885 | Desaparicion de Joaquim de Almeida | Lisboa |
| 1897 | Hallazgo del codex en las obras de restauracion | Sao Bento |
| 1897 | Sousa encuentra la carta de Frei Jeronimo | Oporto |
| 1897-1898 | Investigacion en archivos de Oporto y Lisboa | Varios |
| 1898 | Descubrimiento de la Biblioteca Secreta | Sintra |
| 1898-1899 | Trabajos de desciframiento del codex | Evora |
| 1899 | Elaboracion del Mapa de las Estrellas | Evora |

## Bibliografia recomendada

- A. H. de Oliveira Marques, *Historia de Portugal*, 3 vols. (Lisboa, 1972-1980)
- J. Barradas, <cite>Criptografia e Diplomacia no Portugal Quinhentista</cite> (Coimbra, 1901)
- M. L. Rodrigues, *Arquivos e Bibliotecas: Uma Historia Silenciada* (Porto, 1895)
- F. F. Lopes, *O Romanceiro Tradicional Portugues e a Memoria Escrita* (Lisboa, 1899)
{.list-unstyled .hanging-indent}
